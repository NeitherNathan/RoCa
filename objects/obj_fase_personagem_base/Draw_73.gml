	...
	//Provavelmente nao deveriam existir essas variaveis
	...
	//Color morte effect
	if (global.morte && global.morte_alpha < 1.0)
	{
		var _alpha = 0.5 + (0.5 * cos(current_time * 0.010));
		draw_sprite_ext(sprite_index, image_index, x, y, _scale, _scale, image_angle, c_red, _alpha);
	}